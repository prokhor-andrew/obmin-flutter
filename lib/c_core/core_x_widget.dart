...
class CoreXWidget<DomainState, Loggable> extends StatelessWidget {
  ...
  final Set<Machine<DomainState, Writer<DomainState, Loggable> Function(DomainState state), Loggable>> Function(DomainState state) machines;
  final List<MachineLogger<Loggable>> Function() loggers;

  final Widget Function(
    BuildContext context,
    DomainState state,
    void Function(Writer<DomainState, Loggable> Function(DomainState))? update,
  ) builder;
  ...
  Widget build(BuildContext context) {
    return CoreWidget<DomainState, Writer<DomainState, Loggable> Function(DomainState state), Loggable>(
      state: state,
