...
CoreWidget<(DomainState, void Function(Writer<DomainState, Loggable> Function(DomainState))?), DomainState, DomainState,
  ...
  return CoreWidget<(DomainState, void Function(Writer<DomainState, Loggable> Function(DomainState))?), DomainState, DomainState,
      Writer<DomainState, Loggable> Function(DomainState), Loggable>(
    core: core,
    init: (state) {
      return (state, null);
    },
