...
final class Product<T1, T2> {
  ...
  static Mutator<Product<T1, T2>, Product<T1, T2>> identity<T1, T2>() => Mutator.identity<Product<T1, T2>>();
}
...
extension ProductObminOpticFoldSetExtension<Whole, T1, T2> on FoldSet<Whole, Product<T1, T2>> {
  FoldSet<Whole, T1> get value1 => composeWithGetter(Getter<Product<T1, T2>, T1>((whole) => whole.value1));

  FoldSet<Whole, T2> get value2 => composeWithGetter(Getter<Product<T1, T2>, T2>((whole) => whole.value2));
}
