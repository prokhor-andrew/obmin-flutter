...
extension ChamberMachineExtension on MachineFactory {
  Machine<Input, Output> chamber<Input, Output, Helper>({
    ...
    required ISet<Silo<Output>> Function(Helper helper) initial,
    required ISet<Silo<Output>> Function(Helper helper, Input input) map,
    ...
    Feature<Helper, Output, Never, Input, Output> config(Helper helper, ISet<Silo<Output>> machines) {
          ...
          switch (trigger) {
            case InternalFeatureEvent<Output, Input>(value: final value):
              return FeatureTransition(
                ...
                effects: IList([ExternalFeatureEvent(value)]),
              );
  ...
  Machine<State, Update<State>> chamberX<State, Helper>({
    ...
    required ISet<Silo<Update<State>>> Function(Helper helper, State state) map,
